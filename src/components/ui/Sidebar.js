    ...
    return (
         ...
         <div className="md:w-2/5 xl:w-1/6 bg-blue-800">
             <div className="p-6">
                ...
                <p className="uppercase text-white tracking-wide text-center font-bold">Panel de gestión</p>
                ...
                <nav className="mt-10">
                    ...
                    <NavLink className="p-1 text-white block hover:bg-gray-600 hover: text-white-500" activeClassName="text-white-500" exact="true" to="/Reservas">Reservas</NavLink>  
